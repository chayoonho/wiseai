...
public class SimplePaymentGateway implements PaymentGateway {
    ...
    public PaymentResult processPayment(Payment payment) {
        // B사 API 호출
        String rawResponse = "<result><state>OK</state><tid>SIMPLE_67890</tid></result>";

        // B사 응답을 PaymentResult 공통 모델로 변환
        return PaymentResult.builder()
                .status(PaymentStatus.SUCCESS)
                .transactionId("SIMPLE_67890")
    ...
    public void processWebhook(Map<String, Object> webhookData) {
        ...
        try {
            ...
            log.info("SimplePaymentGateway 웹훅 처리 성공. 거래 ID: {}, 상태: {}", transactionId, newStatus);
